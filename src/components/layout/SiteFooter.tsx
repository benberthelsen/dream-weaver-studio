        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="space-y-4">
            <Link to="/" className="flex items-center gap-3">
              ...
              <span className="font-bold text-lg text-primary-foreground uppercase tracking-wide">Bower Building</span>
            </Link>
          ...
          {/* Navigation */}
          <div className="space-y-4">
            <h4 className="font-semibold text-primary-foreground text-sm uppercase tracking-wider">Navigate</h4>
          ...
          {/* Pro Tools */}
          <div className="space-y-4">
            <h4 className="font-semibold text-primary-foreground text-sm uppercase tracking-wider">Pro Tools</h4>
            <nav className="flex flex-col gap-2 text-sm">
              <Link to="/collections" className="hover:text-primary-foreground transition-colors">Material Collections</Link>
              <Link to="/board" className="hover:text-primary-foreground transition-colors">Board Builder</Link>
            </nav>
          </div>

          {/* Contact */}
          <div className="space-y-4">
            <h4 className="font-semibold text-primary-foreground text-sm uppercase tracking-wider">Contact</h4>
            <div className="flex flex-col gap-3 text-sm">
              <a href="tel:0400000000" className="flex items-center gap-2 hover:text-primary-foreground transition-colors">
